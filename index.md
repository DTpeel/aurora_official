...
# 宣传片
<div id="playerWrap" class="player-wrap" style="height: auto;"><div id="bofqi" style="width: 638px; height: 493px; position: static;"><div class="player" style="width:100%;height:100%;"><div id="bilibiliPlayer" class="bilibili-player relative" data-login="false">
        <div class="bilibili-player-area video-state-pause video-control-show video-state-blackside" aria-label="哔哩哔哩播放器">
            ...
            <div class="subtitle-position subtitle-position-bc">
                ...
                <div class="bilibili-player-video"><video preload="auto" src="blob:https://www.bilibili.com/25e9bbc8-c4a2-472a-a238-e2c817fcc500"></video></div>
    ...
    <div class="bui-thumb" style="transform: translateX(-8.82973px);">
...
</div></div><div class="bilibili-player-video-progress-detail" style="left: 190.5px;"><div class="bilibili-player-video-progress-detail-container" style="margin-left: -80px; width: 160px;">
                <div class="bilibili-player-video-progress-detail-img" style="width: 160px; height: 90px; line-height: 90px; background-image: url(&quot;//i0.hdslb.com/bfs/videoshot/129823086.jpg&quot;); background-position: -1120px 0px;">
                    <div class="bilibili-player-video-progress-detail-time">00:36</div>
                </div>
    ...
    <div class="bui-select-border">
        ...
        <div class="bui-select-list-wrap" style="">
            <ul class="bui-select-list" style="bottom: 41px; border: none; left: -52px;">
    ...
    <div class="bui-thumb" style="transform: translateX(0.173597px);">
